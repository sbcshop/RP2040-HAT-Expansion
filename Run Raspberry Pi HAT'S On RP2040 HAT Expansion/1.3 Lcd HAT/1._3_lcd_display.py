...
joystick_down = machine.Pin(11,Pin.IN, Pin.PULL_UP)
joystick_left = machine.Pin(12,Pin.IN, Pin.PULL_UP)
joystick_right = machine.Pin(10,Pin.IN, Pin.PULL_UP)
joystick_centre = machine.Pin(13,Pin.IN, Pin.PULL_UP)

key1 = machine.Pin(15,Pin.IN, Pin.PULL_UP)
key2 = machine.Pin(16,Pin.IN, Pin.PULL_UP)
