...
joystick_up = machine.Pin(11,Pin.IN, Pin.PULL_UP)
joystick_down = machine.Pin(12,Pin.IN, Pin.PULL_UP)
joystick_left = machine.Pin(14,Pin.IN, Pin.PULL_UP)
joystick_right = machine.Pin(10,Pin.IN, Pin.PULL_UP)
joystick_centre = machine.Pin(13,Pin.IN, Pin.PULL_UP)

spi = SPI(0, baudrate=40000000, sck=Pin(2), mosi=Pin(3))
tft = gc9a01.GC9A01(spi,reset=Pin(8, Pin.OUT),cs=Pin(5, Pin.OUT),dc=Pin(22, Pin.OUT),backlight=Pin(26, Pin.OUT),rotation=0)
